...
本项目唯一的联网操作是版本检测，仅在启动时（或用户手动检查更新时）请求以下地址获取最新版本信息：
版本检测地址：`https://liuyun.cn-nb1.rains3.com/latest.json`
该请求仅用于比对版本号、获取更新链接及更新说明，不会上传任何用户数据。
